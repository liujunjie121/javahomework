<%@ page import="club.banyuan.pojo.Order" %>
            ...
            <table border="0" class="order_tab" style="width:930px; text-align:center; margin-bottom:30px;"
                ...
                <%
                    ...
                    for (Order order : orderList) {
                        out.print("<tr>");
                        out.print("<td><font color=\"#ff4e00\">" + order.getId() + "</font></td>");
                        out.print("<td>"+order.getCreateTime()+"</td>");
                        out.print("<td>￥" +order.getCost()+" </td>");
                        out.print("<td>已确认，已付款，已发货</td>");
                        out.print("<td><font color=\"#ff4e00\">已确认</font></td>");
                        out.print("</tr>");
                    }
                %>
