                ...
                for (Cookie cookie : cookies) {
                    if (cookie.getName().equals("loginName")) {
                        out.println("<span class=\"fl\">你好，" + cookie.getValue()
                                + "请<a href=\"login.jsp\">登录</a>&nbsp; <a href=\"regist.jsp\" style=\"color:#ff4e00;\">免费注册</a>");
                        flag = true;
                    }
                }
                if (flag == false) {
                    out.println("<span class=\"fl\">你好，请<a href=\"login.jsp\">登录</a>&nbsp; <a href=\"regist.jsp\" style=\"color:#ff4e00;\">免费注册</a>");
                }
            }
            else{
                User user = (User)obj;
                out.println("<span class=\"fl\">欢迎<a href=\"member/member.jsp\">" + user.getLoginName() + "</a>");
            }
        %>
            |&nbsp;<a href="#">我的订单</a>&nbsp;|</span>
        	<span class="ss">
